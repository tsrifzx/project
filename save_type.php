...
<div style='background-color:#2980b9;text-align:right; padding-right:10px; font-color:#ffffff; height:25px; font-size:10pt; padding-top:10px;'><span style="color:#ffffff">Welcome  </span>  
	...
	<a href="logout.php"  onclick="return confirm('ยืนยันการออกจากระบบ')"><span class="enrightlink">[Log out]</span></a>
		</div>
...
<span style="font-size:11pt; font-weight:bold;">บันทึกประเภทวัสดุ( Save Article Type)</span><br><br>
	<table style="width:100%; border: 1px solid #eeeeee; ">
        ...
        <form action="save_typeart.php" method="post">
		 <fieldset><br>
		 <legend>บันทึกประเภทวัสดุ</legend>
		<p> รหัสประเภท. :<input type="text" name="category_id" size=30
						required="require" placeholder="Enter Unit ID">
		<p> ชื่อประเภท :<input type="text" name="category_name" size=30 required="require"
...
echo "<tr><th>รหัสประเภท</th><th>ชื่อประเภท</th><th colspan='2'>เลือกทำงาน</th></tr>";
...
echo "<td><a href=\"disp_category.php?category_id=$category_id\">Edit</a></td>\n";
//สร้าง link ไปยังโปรแกรม php ที่ทำหน้าที่ลบข้อมูลรพร้อมส่งรหัสแผนกหัสแผนก
echo "<td><a href=\"del_type.php?category_id=$category_id\" onclick=\"return confirm('คุณต้องการลบข้อมูลใช่หรือไม่ ?')\">Delete</a></td>\n";
echo "\t</tr>\n";
}
echo "</table>";

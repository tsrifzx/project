...
<div  class="container">
	<div id="header">
		<div id="logo">
			...
			<a href="../admin1/list_inventory.php" style="font-size:12pt">ระบบจัดการวัสดุสำนักงาน</a><br>
			<span><a href="../admin1/list_inventory.php" rel="nofollow" style="font-size:10pt">Inventory Control System</a></span>
		</div>
		<div id="menu">
			<ul>
...
<span style="font-size:11pt; font-weight:bold;">รายการพัสดุ ( Article List)</span><br><br>
...
echo "<tr><th>ลำดับ</th><th>รหัสพัสดุ</th><th>ชื่อพัสดุ</th><th>ประเภทพัสดุ</th><th>หน่วยนับ</th><th>จำนวนพัสดุทั้งหมด</th></tr>";
...
echo "<center>จำนวนข้อมูลทั้งหมด  :",$result->rowCount(),"รายการ</center><br>";

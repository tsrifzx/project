...
<div  class="container">
	<div id="header">
		<div id="logo">
			...
			<span><a href="#" rel="nofollow" style="font-size:10pt">Inventory  Control  System
</a></span>
		</div>
		<div id="menu">
			<ul>
...
<div id="main" style="height:100%">
		...
		<div id="banner" style="background:url('https://eds.trang.psu.ac.th/mis/supply/stock/images/bktitle.jpg') right; height:90px">
			<div class="title" style="padding-top:25px">
				...
				<span class="byline">Inventory  Control  System
</span>
			</div>
		</div>
...
<span style="font-size:11pt; font-weight:bold;">รายการขอเบิกวัสดุ (Request Article List)</span><br><br>
